...
class WeekTopStories extends StatefulWidget {
    const WeekTopStories({super.key});

    @override
    WeekTopStoriesState createState() => WeekTopStoriesState();
}

class WeekTopStoriesState extends State<WeekTopStories> {
