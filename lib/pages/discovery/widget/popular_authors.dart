...
class PopularAuthors extends StatefulWidget {
    ...
    @override
    PopularAuthorsState createState() => PopularAuthorsState();
}

class PopularAuthorsState extends State<PopularAuthors> {
    ...
    void initState() {
        ...
        _userList = userList.where((element) => element.official == 0).toList();
    }
